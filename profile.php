            ...
            <div class="row">
                <div class="col-md-4">
                    <?php if (isset($_SESSION["userLogin"])) { ?>
                        <h6 class='badge text-bg-primary fs-6'>Hello <span class="text-white"><?php echo $_SESSION['userName']; ?></span></h6>
                    <?php } ?>
                    <?php if (isset($_SESSION["adminLogin"])) { ?>
                        <h6 class='badge text-bg-primary fs-6'>Hello <span class="text-white"><?php echo $_SESSION['adminName']; ?></span></h6>
                    <?php } ?>
                        ...
                        <div class="card-body">
                            <ul class="nav flex-column my-2">
                                <li class="nav-item border-bottom ">
                                    <a class="nav-link text-dark fw-semibold fs-6" href="profile.php?status=appointments"><i class="fa-regular fa-calendar-check text-info"></i> My Appointments</a>
                                </li>
                                <?php if (!isset($_SESSION["adminLogin"])) { ?>
                                    <li class="nav-item border-bottom ">
                                        <a class="nav-link text-dark fw-semibold fs-6" href="profile.php?status=profile"><i class="fa-regular fa-user text-info"></i> My Profile</a>
                                    </li>
                                    <li class="nav-item border-bottom ">
                                        <a class="nav-link text-dark fw-semibold fs-6" href="profile.php?status=change_password"><i class="fa-solid fa-lock text-info"></i> Change Password</a>
                                    </li>
                                <?php } ?>
                                <li class="nav-item border-bottom ">
                                    <a class="nav-link text-dark fw-semibold fs-6" href="profile.php?status=support"><i class="fa-solid fa-phone-volume text-info"></i> Support</a>
                                </li>
                                <li class="nav-item border-bottom ">
                                    <a class="nav-link text-dark fw-semibold fs-6" href="logout.php"><i class="fa-solid fa-right-from-bracket text-info"></i> Log Out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card shadow" style="width: 100%;">
                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-2 d-flex align-items-center justify-content-end">
                                        <input type="submit" class="btn btn-primary" name="submit" value="Update Password" id="submitId">
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card shadow" style="width: 100%;">
                            ...
                            <div class="card-body">
                                <ul class="nav flex-column">
                                    <li class="nav-item border-bottom">
                                        <h6 class="nav-link text-dark fw-semibold"><i class="fa-regular fa-envelope text-info"></i> Email : ayon2465@gmail.com</h6>
                                    </li>
                                    <li class="nav-item border-bottom">
                                        <h6 class="nav-link text-dark fw-semibold"><i class="fa-regular fa-envelope text-info"></i> Email : sakibcse282@gmail.com</h6>
                                    </li>
                                    <li class="nav-item border-bottom">
                                        <h6 class="nav-link text-dark fw-semibold"><i class="fa-solid fa-phone-volume text-info"></i> Phone : 01797327584</h6>
                                    </li>
                                    <li class="nav-item border-bottom">
                                        <h6 class="nav-link text-dark fw-semibold"><i class="fa-solid fa-phone-volume text-info"></i> Phone : 01608544792</h6>
                                    </li>
                                    <li class="nav-item border-bottom">
                                        <h6 class="nav-link text-dark fw-semibold"><i class="fa-solid fa-globe text-info"></i> Website : www.asa.com</h6>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        ?>
                            <div class="card shadow" style="width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <label class="form-label"><b>Appointment No:</b> <span id="apt_no"><?php echo $apt_no; ?></span></label><br />
                                    <label class="form-label"><b>Appointment Day:</b> <span id="apt_day"><?php echo $date; ?></span></label><br />
                                    <label class="form-label"><b>Appointment Time:</b> <span id="apt_time"><?php echo $start_time; ?></span></label><br />
                                    <hr />
                                    <label class="form-label"><b>Patient Name:</b> <span id="patient_name"><?php echo $patient_name; ?></span></label><br />
                                    <label class="form-label"><b>Patient Email:</b> <span id="patient_email"><?php echo $patient_email; ?></span></label><br />
                                    <label class="form-label"><b>Patient Contact:</b> <span id="patient_contact"><?php echo $patient_contact; ?></span></label><br />
                                    <hr />
                                    <label class="form-label"><b>Doctor Name:</b> <span id="doctor_name"><?php echo $doctor_name; ?></span></label><br />
                                    <label class="form-label"><b>Doctor Department:</b> <span id="doctor_department"><?php echo $doctor_department; ?></span></label><br />
                                    <label class="form-label"><b>Doctor Specialization:</b> <span id="doctor_spec"><?php echo $doctor_spec; ?></span></label><br />
                                    <label class="form-label"><b>Doctor fees:</b> <span id="doctor_fees"><?php echo $fees; ?></span></label><br />
                                    <hr />
                                    <label class="form-label"><b>Payment Amount:</b> <span id="amount"><?php echo $fees; ?></span></label><br />
                                    <hr />
                                    <div class="d-md-flex justify-content-md-end payment-btn">
                                        <button type="button" class="btn btn-secondary me-md-3 payment-cancel-btn" data-bs-dismiss="modal"><a class='text-decoration-none text-white' href="profile.php?status=appointments">Cancel</a></button>
                                        <form action="payment.php" method="POST" class="payment-btn">
                                            ...
                                            <input type="submit" name="payment" value="Payments" class="btn btn-primary payment-submit-btn">
                                        </form>
                                    </div>
                                    <?php //} 
                                    ?>
